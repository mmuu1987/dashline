...
export const CORE_VERSION = 'core.4';
...
export const COYOTE_TICKS = 5; // 土狼时间 ~83ms
export const BUFFER_TICKS = 6; // 预输入缓冲 ~100ms
export const HOLD_MAX_TICKS = 15; // 长按蓄力上限 ~250ms
